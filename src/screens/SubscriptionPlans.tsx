...
const SubscriptionPlans = ({navigation}) => {
  const gradientColors = ['rgb(255, 247, 176)', 'rgb(255, 233, 125)'];
    ...
    <View style={styles.parentsAccessScreen}>
      <ScrollView style={styles.mainScrollView}>
        <View style={styles.premiumSubscriptionView}>
          ...
          <Image
            source={require('../assets/images/PremiumSubscription-Large.png')}
          ...
          <View style={styles.subscriptionTexts}>
            <Text
              ...
              size={19}
              color={Colors.white}
              style={{paddingHorizontal: '5%', top: '-55%'}}>
              خطة الاشتراك
            </Text>
            <Text
              GulfText
          ...
          <View style={styles.plansPlates}>
            <View style={styles.monthlyYearlyPlan}>
              <Image
                source={require('../assets/images/Yearly-Plan.png')}
                style={{top: '-5%', alignSelf: 'center'}}
              />
              <Text
                center
                GulfText
              ...
              <Text style={{alignSelf: 'center', top: '-17%'}}>
                ...
                <Text center GulfText size={15} color={'#f0f0f2'} style={{}}>
                  {' '}
                  سنوياً
                </Text>
              </Text>
              <Text style={{alignSelf: 'center', top: '-23%'}}>
                ...
                <Text center GulfText size={13} color={'#f0f0f2'} style={{}}>
                  {' '}
                  / شهر
                </Text>
                <Text
            ...
            <View
              style={[
                styles.monthlyYearlyPlan,
                {borderWidth: 0, height: 230, bottom: '-3.5%'},
              ]}>
              <Image
                source={require('../assets/images/Monthly-Plan.png')}
          ...
          <Text center style={{paddingHorizontal: '8%', bottom: '14.5%'}}>
            ...
            <Text
              ...
              color={Colors.white}
              style={{lineHeight: 20}}>
              أيام المجانية التجريبية، سيتم تحصيل{' '}
            </Text>
            <Text
              SFProRoundedRegular
              size={13}
            ...
            <Text
              ...
              style={{lineHeight: 20}}>
              {' '}
              دولارًا منك ما لم تقم بإلغاء الاشتراك ما لا يقل عن 24 ساعة قبل
              التجديد في 24 يناير 2022. أول 7 أيام مجاناً.
            </Text>
          </Text>

          <View
            style={{flexDirection: 'row', alignSelf: 'center', bottom: '40%'}}>
            <Text
              GulfText
              size={13}
          ...
          <LinearGradient
            ...
            <Text center GulfSemiBold size={20} color={Colors.paua}>
              لماذا يحبنا الأطفال والأهالي؟
            </Text>
            <Text
              center
              GulfText
              ...
              {'تعرّف على بعض من آراء الأطفال والآباء حول قصصنا والتطبيق.'}
            </Text>
            <Image
              source={require('../assets/images/ChildrenAndAnimals.png')}
              style={styles.childrenAnimals}
            />
          </LinearGradient>
        </View>
      </ScrollView>
