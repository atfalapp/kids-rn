...
const Album = ({item, index, length}) => {
  ...
  const Icon = item.img_label ? circles_colors[item.name] : undefined;
    ...
    <TouchableOpacity
      style={[
        ...
        // eslint-disable-next-line react-native/no-inline-styles
        {
          ...
          marginRight: index == length ? 28 : 14,
        },
      ]}
      ...
      <ImageBackground
        ...
        source={{uri: `${url}/images/${item.img_label}-large.png`}}>
        {/* source={item.img}> */}
        ...
        {Icon ? (
          <View style={styles.circle}>
            ...
            <Text
              ...
              {index === 1 ? item.audios_count : '1'}
            </Text>
          </View>
        ) : null}
      </ImageBackground>

      <Text GulfSemiBold size={15} color="#2f4c63" style={styles.title}>
        {item.name}
      </Text>
    </TouchableOpacity>
  ) : null;
