      ...
      fav || item.img_label ?
        <TouchableOpacity
          ...
          onPress={() => {
            ...
            item.name || fav ? navigation.navigate('StoryDetails', { item, fav }) : null
          }}>
          <ImageBackground style={styles.storyPlate} source={require('../assets/images/StoryMainPlate.png')} resizeMode='stretch'>
            <TouchableOpacity style={styles.play}
              ...
              onPress={() => item.name || fav ? navigation.navigate('StoryDetails', { item, fav }) : null}>
              <Play />
            </TouchableOpacity>
            ...
            <View style={styles.details}>
              <View style={{ width: "40%" }}>
                <Text GulfSemiBold size={17} color="#2f4c63"
                  style={item.name && item.name.split(" ").length > 2 ? styles.title : null}>{item.name ? item.name : item.title}</Text>
              </View>
